...
public class Servidor {
    public static void main(String[]args){
        try{
            ...
            //Socket Servidor
            SSLServerSocket serverSocket = (SSLServerSocket) serverSocketFactory.createServerSocket();//Aqui puerto?
            ...
            //Accept del servidor al cliente
            SSLSocket socketPrueba = (SSLSocket) serverSocket.accept();

            //Creacion del InputStream
            InputStream inputStream = socketPrueba.getInputStream();

            //Creacion Mensajes
            byte[] mensaje = new byte[50];
            byte[] mensaje2 = new byte[50];

            //Lectura del mensaje
            inputStream.read(mensaje);

            //Creacion del string usuario
            String usuario = new String(mensaje);

            //Comprobacion en el fichero
            FileReader fileReader = new FileReader("C:/Users/domin/Desktop/usuarios.txt");
            BufferedReader bufferedReader = new BufferedReader(fileReader);

            //Creacion de login
            String login = new String(bufferedReader.readLine());
            //String login ="JESUS";
...
public class Cliente {
    ...
    public static void main(String[]args){
        ...
        try{
            ...
            //Conexion a localhost(Error aqui)
            clientSocket.connect(addr);

            //Creacion del OutputStream
            OutputStream os = clientSocket.getOutputStream();

            //Creacion y lectura del mensaje
            String mensajeCliente = bufferedReader.readLine();
